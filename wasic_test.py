...
def use_as_library():
    ...
    conn_object.backend = Config().get("custom_backend", "")
    tbs_scpi_info = SCPI_Info("USB0::0x0699::0x03C4::C034147::INSTR", 0, "TBS1052C", "TBS1052C", "TBS1052C")
    ...
    tasks = Tasks()
    tbs = conn_object.get_instrument("TBS1052C").scpi_instrument
